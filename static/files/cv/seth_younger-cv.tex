...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize*}
			...
			\item Quantified longleaf pine restoration effects on hydrology using long-term streamflow data, southeast U.S. watersheds with longleaf have higher streamflow and less extreme low flows.
			\item Mentored a graduate student on hydrologic analysis as part of a collaborative project quantifying the hydrology and economics of different forest restoration practices, one paper has been submitted and another is underway.
			...
			\item Lead manuscript development including team meetings, analysis, writing, revising, and journal correspondence.
	...
	\begin{hangparas}{.25in}{1}
		...
		\textbf{Younger, S.E.}, Blake, J.I., Jackson, C.R., \& Aubrey, D.P. (In press). Hydrogen isotopic offsets in xylem water measurements under cryogenic vacuum distillation: quantifying and correcting wood-water hydrogen exchange influences. \textit{Ecohydrology} DOI: 10.1002/ECO.2640
