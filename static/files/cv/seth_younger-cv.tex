...
\begin{document}
	...
	\begin{indentsection}{\parindent}
		...
		\begin{description*}
			\item[]
			Data analysis and statistics in \textit{R \& Python}. Documentation with \LaTeX\ and \textit{Markdown}. Version control with \textit{Github}. Writing and presentation with \textit{Microsoft Office}
...
\begin{hangparas}{.25in}{1}
	...
	\textbf{Younger, S.E.}, Blake, J.I., Jackson, C.R., \& Aubrey, D.P. (Under revision). Hydrogen isotopic offsets in xylem water measurements under cryogenic vacuum distillation: quantifying and correcting wood-water hydrogen exchange influences. \textit{Ecohydrology}
