...
\begin{document}
	...
	\begin{itemize}
		...
		{\emph{starting late 1/2021}}
		\begin{itemize*}
			\item Hydrologic modeling of Longleaf Pine Restoration and forest management across the southeast.
		\end{itemize*}
		...
		\item
		\headerrow
		{\textbf{Writing, Consulting and Volunteer Work}}
		{\textbf{Athens, GA}}
		\\
		\headerrow
		{\emph{Various Roles}}
		{\emph{9/2020 - 12/2020}}
		\begin{itemize*}
			\item Worked towards publication of completed research.
			\item Cartograhy projects for Nutter and Associates.
			\item Volunteer work with SORBA Athens.
		\end{itemize*}
