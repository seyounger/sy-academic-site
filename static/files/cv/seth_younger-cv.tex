...
\begin{document}
	...
	\begin{itemize}
		...
		\\
		\headerrow
		{\emph{Postdoctoral Research Associate - Hydrologist}}
		{\emph{1/2021 - present}}
		\begin{itemize*}
			\item Conducted the full life cycle of research including defining a research problem, developing hypotheses, grant writing, collecting data, quality control, database development, developing innovative techniques for analysis, publishing results, and communicating the findings to a wide audience. Analysis with Python, R, SQL, and Google Earth Engine.
			\item Quantified longleaf pine restoration effects on hydrology using long-term streamflow data, southeast U.S. watersheds with longleaf have higher streamflow and less extreme low flows. Lead manuscript development including team meetings, analysis, writing, revising, and journal correspondence. \href{https://doi.org/10.1016/j.scitotenv.2023.165999}{Younger et al. 2024}
			\item Mentored graduate students on hydrologic analysis as part of a collaborative project quantifying the hydrology and economics of different forest restoration practices, one paper has been submitted and another is underway.
			\item Developed Soil and Water Assessment Tool (SWAT) models to quantify the effects of future climates on the hydrology of longleaf pine ecosystems.
			\item Contributed to the writing of a successful grant proposal (600k) quantifying the role of upland forest management on wetland health, 2024-2026.
		\end{itemize*}
		...
		{\emph{8/2014 -- 7/2020}}
		\begin{itemize*}
			\item Investigated long-term watershed scale evapotranspiration as a function of biotic \& abiotic factors in the Southeastern U.S. Published in the Journal of Hydrology: \href{https://doi.org/10.1016/j.jhydrol.2020.125316}{Younger et al. 2020}
			...
			\item Lead cryogenic vacuum extraction of ~1,300 plant and ~1,300 soil samples for water isotope analysis.
			\item Developed plot level component water budgets for \emph{Pinus taeda} \& \emph{Eucalyptus benthamii} trees using estimates of precipitation, canopy interception, evaporation, transpiration isotopic water sourcing techniques including sap flow sensors \& lysimeters: \href{https://doi.org/10.1007/s12155-023-10591-w}{Younger et al. 2023}
			\item Contributed to five publications with study design, data analysis, visualization, reviewing \& editing.
		\end{itemize*}
		...
		{\emph{5/2009 -- 7/2010}}
		\begin{itemize*}
			\item Collected, analyzed and managed spatial data and made maps to support the New River Valley, VA Planning District Commission 2010 FEMA Hazard Mitigation Plan update.
	...
	\begin{hangparas}{.25in}{1}
		...
		\textbf{Younger, S.E.}, Blake, J.I., Jackson, C.R., \& Aubrey, D.P. (2024). Hydrogen isotopic offsets in xylem water measurements under cryogenic vacuum distillation: quantifying and correcting wood-water hydrogen exchange influences. \textit{Ecohydrology} \url{https://doi.org/10.1002/ECO.2640}
